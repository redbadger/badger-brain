...
export function sanitizeEventsBanner(json) {
  const get = makeGetter(json);
  return {
    url: pathOr(null, ['url'], get('events-banner.link')),
    altText: get('events-banner.alt-text') ? get('events-banner.alt-text')[0].text : null,
    desktop: pathOr(
      null,
      ['main', 'url'], get('events-banner.desktop')),
    tablet: pathOr(
      null,
      ['main', 'url'], get('events-banner.tablet')),
    mobile: pathOr(
      null,
      ['main', 'url'], get('events-banner.mobile')),
  };
}
