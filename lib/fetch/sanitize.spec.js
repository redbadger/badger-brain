    ...
    it('converts the raw json provided by prismic to be readable by graphql', () => {
      const rawData = {
        data: {
          ...
          'event-banner.desktopURL': { value: { main: { url: 'https://face.gif' } } },
          'event-banner.tabletURL': { value: { main: { url: 'https://face.gif' } } },
          'event-banner.mobileURL': { value: { main: { url: 'https://face.gif' } } },
        },
      };
