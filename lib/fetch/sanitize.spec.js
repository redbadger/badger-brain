    ...
    it('should extract real values', () => {
      const event = deepFreeze({
        ...
        data: {
          ...
          'event.featured-image': { value: { main: { url: 'https://foo.png' } } },
    ...
    it('converts the raw json provided by prismic to be readable by graphql', () => {
      const rawData = {
        ...
        data: {
          ...
          'organisation.organisation-image': { value: { main: { url: 'https://exampleImage.gif' } } },
        ...
        const rawData = {
          ...
          data: {
            ...
            'q-and-a.answer': { value: [
              {
                type: 'paragraph',
                text: 'This is totally dependent on your requirements, but Red Badger\u2019s ' +
...
'competitor whose day-rate might be cheaper, but would take longer.',
                spans: [
                  ...
                  },
                  {
                    ...
                    type: 'hyperlink',
                    data: { type: 'Link.web', value: { url: 'https://red-badger.com' } },
                  },
                ],
              },
              {
                type: 'paragraph',
                text: 'Obviously all projects are completely different, a further discussion ' +
...
'able to forecast in more accuracy once the project is complete.',
    ...
    it('converts the raw json provided by prismic to be readable by graphql', () => {
      const rawData = {
        ...
        data: {
          ...
          'webinar.featured-image': { value: { main: { url: 'https://face.gif' } } },
  ...
  describe('sanitizeEventsBanner', () => {
    ...
    it('converts the raw json provided by prismic to be readable by graphql', () => {
      const rawData = {
        data: {
          'events-banner.link': { value: { url: 'http://example.com' } },
          'events-banner.alt-text': { value: [{ text: 'testtext' }] },
          'events-banner.desktop': { value: { main: { url: 'https://face.gif' } } },
          'events-banner.tablet': { value: { main: { url: 'https://face.gif' } } },
          'events-banner.mobile': { value: { main: { url: 'https://face.gif' } } },
        },
      };
      ...
      expect(result).to.deep.equal({
        ...
        altText: 'testtext',
        desktop: 'https://face.gif',
        tablet: 'https://face.gif',
        mobile: 'https://face.gif',
      });
    });
