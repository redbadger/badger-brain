...
describe('Fetch', () => {
  ...
  describe('All', () => {
    it('should fetch events', async () => {
      ...
      const result = await AllEventsFetch();
    ...
    it('should fetch news', async () => {
      ...
      const result = await AllEventsFetch.bind({docType: docType})();
