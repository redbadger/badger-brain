...
const BlogPostExcerpt = new GraphQLObjectType({
  name: 'BlogPostExcerpt',
  fields: {
    url: {
      type: GraphQLString,
      description: 'The url for the full blogpost',
    },
    title: {
      type: GraphQLString,
    ...
    author: {
      type: GraphQLString,
      description: 'The name of the blogs author',
    },
    excerpt: {
      type: GraphQLString,
      description: 'A short excerpt of the full blog post',
    },
    date: {
      type: GraphQLString,
      description: "The date of the blog's publicaiton",
    },
  },
});
...
export const BlogPostSchemaFields = {
  ...
  blogPostExcerptsByTag: {
    type: new GraphQLList(BlogPostExcerpt),
    description: 'Request a list of blog posts',
    args: {
      limit: {
        type: GraphQLInt,
      ...
      topic_id: {
        type: GraphQLFloat,
        description: 'A numeric tag that identified the type of blogpost',
      },
    },
    resolve: (source, args) => fetchBlogPostExcerptsByTag(args),
  },
};
