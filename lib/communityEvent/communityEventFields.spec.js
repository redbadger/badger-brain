...
const CommunityEventFields = injectr('../../lib/communityEvent/communityEventFields.js', {
  '../fetch': mockFetch,
});

const CommunityEventSchema = new GraphQLSchema({
  query: new GraphQLObjectType({
    name: 'Query',
    fields: CommunityEventFields.EventSchemaFields,
  }),
});

describe('CommunityEvent Queries', () => {
  it('should be able to get events based on provided tag', async () => {
    ...
    const result = await graphql(CommunityEventSchema, query);
