...
export async function sanitizeGoldCoinPage(json, options) {
  ...
  return {
    ...
    whatIsIt: new Prismic.Fragments.StructuredText(
      get('gold_coin_page.what_is_it')
    ).asHtml(),
    whoIsItFor: new Prismic.Fragments.StructuredText(
      get('gold_coin_page.who_is_it_for')
    ).asHtml(),
    whatWillYouLearn: new Prismic.Fragments.StructuredText(
      get('gold_coin_page.what_will_you_learn')
    ).asHtml(),
    whoWillRun: new Prismic.Fragments.StructuredText(
...
function sanitizeHubspotConsentData(json) {
  ...
  if (rawData) {
    return {
      consentMessage: rawData.processingConsentCheckboxLabel,
