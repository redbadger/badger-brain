...
import { fetchEvent, fetchAllEvents, getSpeakersByEventId } from './fetch';
import { SpeakerType } from './speakerFields';
...
export const EventType = new GraphQLObjectType({
  ...
  fields: {
    ...
    speakers: {
      ...
      description: 'List of speakers related the event',
      resolve(event) {
        return getSpeakersByEventId(event.id);
      },
    },
  },
});
