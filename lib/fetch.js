...
export function sanitizeEventAndNews(item, type) {
  ...
  return {
    ...
    datetime: item.data[`${type}.timestamp`] ?
      item.data[`${type}.timestamp`].value : null,
    startDateTime: item.data[`${type}.timestamp`] ?
      item.data[`${type}.timestamp`].value : null,
    endDateTime: item.data[`${type}.timestampEnd`] ?
      item.data[`${type}.timestampEnd`].value : null,
